...
const EmptyGlobalState = () => {
    ...
    return (
        ...
        >
            ...
            <h1 className="text-3xl font-sora font-bold text-white mb-4">Nothing tracked yet.</h1>
            <p className="text-slate-400 max-w-md mb-8 leading-relaxed">
                Your dashboard is ready and waiting. Add your first income or expense and the insights engine will start doing its thing.
            </p>
